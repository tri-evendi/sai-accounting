...
/**
 * Alamat klien dari header proxy: entri PERTAMA `x-forwarded-for` (yang
 * ditulis Traefik), lalu `x-real-ip`. Tidak ada keduanya → null → DITOLAK
 * oleh `ipAllowed` — bukan diloloskan.
 */
