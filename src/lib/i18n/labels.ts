...
export function permissionResourceLabels(
  ...
  return {
    ...
    bill_of_material: r.bill_of_material,
...
export function permissionLabels(
  ...
  return {
    ...
    "bill_of_material.read": p.bill_of_material_read,
    "bill_of_material.write": p.bill_of_material_write,
    "work_center.manage": p.work_center_manage,
    "production_order.read": p.production_order_read,
    "production_order.write": p.production_order_write,
    ...
    "landed_cost.read": p.landed_cost_read,
    "landed_cost.write": p.landed_cost_write,
