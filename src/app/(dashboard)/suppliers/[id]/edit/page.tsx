...
export default function EditSupplierPage() {
  ...
  if (fetching) return <PageLoader message="Loading supplier..." />;

  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-foreground mb-6">Edit Supplier</h1>
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="grid gap-4">
              <Input id="name" label="Supplier Name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} required />
